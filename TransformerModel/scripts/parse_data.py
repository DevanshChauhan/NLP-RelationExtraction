...
new_ifile = "assets/Predict.BioC.json"
new_ofile='data/Predict_BioC.spacy'

def main(json_loc: Path, test_file: Path):
    ...
    with open(new_ifile, encoding="utf8") as jsonfile:
